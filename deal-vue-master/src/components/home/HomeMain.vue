                        ...
                        <div class="search">
                            <div class="search-input">
                                <el-input v-model="productName" @keydown.enter.native="search" placeholder="搜一搜好货" clearable>
                                    <el-select class="select" v-model="categoryType" slot="prepend">
                                        <el-scrollbar class="gun" wrap-style="overflow-x:hidden;" style="height: 15vh;">
        ...
        data() {
            return {
                ...
                categories: [
                    ...
                    {categoryName:"书籍",categoryType:'book'},
                    {categoryName:"食品",categoryType:'food'},
                    {categoryName:"电子产品",categoryType:'electronics'},
                    {categoryName:"衣物",categoryType:'clothes'},
                    {categoryName:"鞋子",categoryType:'shoes'},
                    {categoryName:"其他",categoryType:'others'},
                ],
                backgroundImage: [
